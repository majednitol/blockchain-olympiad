...
const DoctorPersonalData = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (validateForm() || (name !== " " && consultationFee !== " " && doctorID !== "" && specialty !== " " && BMDCNumber !== " " && yearOfExperience !== " ")) {
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form onSubmit={handleSubmit}>
                                <div class="mb-3">
                                    <label for="recipient-name" class="col-form-label">doctorID :</label>
                                ...
                                <div class="mb-3">
                                    ...
                                    <label for="recipient-name" class="col-form-label">BMDCNumber :</label>
                                    <input type="number" class="form-control" id="BMDCNumber"
                                        name="BMDCNumber"
                                        value={BMDCNumber}
                                    ...
                                    <label for="recipient-name" class="col-form-label">consultationFee :</label>
                                    <input type="number" class="form-control" id="consultationFee"
                                        ...
                                        onChange={handleInputChange}
                                    />
                                    {errors.consultationFee && <span>{errors.consultationFee}</span>}
                                </div> <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <label for="recipient-name" class="col-form-label">yearOfExperience :</label>
                                    <input type="number" class="form-control" id="specialty"
                                        name="specialty"
                                        value={yearOfExperience}
                                        onChange={handleInputChange}
                                        placeholder='Enter your yearOfExperience'
                                    />
                                    {errors.yearOfExperience && <span>{errors.yearOfExperience}</span>}
                                </div>
